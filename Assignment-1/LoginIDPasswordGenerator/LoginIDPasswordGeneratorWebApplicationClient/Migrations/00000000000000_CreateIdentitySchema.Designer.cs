...
using LoginIDPasswordGeneratorWebApplicationClient.Models;

namespace LoginIDPasswordGeneratorWebApplicationClient.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("LoginIDPasswordGeneratorWebApplicationClient.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("LoginIDPasswordGeneratorWebApplicationClient.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
