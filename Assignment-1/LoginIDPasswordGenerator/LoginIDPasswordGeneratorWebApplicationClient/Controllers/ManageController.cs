...
using LoginIDPasswordGeneratorWebApplicationClient;
using LoginIDPasswordGeneratorWebApplicationClient.Models;
using LoginIDPasswordGeneratorWebApplicationClient.Services;

namespace LoginIDPasswordGeneratorWebApplicationClient.Controllers
{
    [Authorize]
